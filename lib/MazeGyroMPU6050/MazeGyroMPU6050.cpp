...
void MazeGyroMPU6050::writeRegister(uint8_t reg, uint8_t value) {
...
int16_t MazeGyroMPU6050::readWord(uint8_t regHigh) {
    Wire.beginTransmission(MPU6050_I2C_ADDR);
    Wire.write(regHigh);
